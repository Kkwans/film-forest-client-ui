export default function Loading() {
  return (
    <div className="flex flex-col gap-10">
      {/* Hero skeleton */}
      <section className="relative overflow-hidden rounded-2xl bg-secondary border border-border" >
        <div className="px-6 py-6 md:px-16 md:py-14 animate-pulse">
          <div className="h-5 w-32 rounded-full mb-4 bg-card"  />
          <div className="h-10 w-3/4 rounded mb-4 bg-card"  />
          <div className="h-6 w-2/3 rounded mb-6 bg-card"  />
      ...
      {[1, 2, 3].map((section) => (
        <div key={section} className="flex flex-col gap-4">
          <div className="flex items-center justify-between">
            <div className="h-7 w-24 rounded animate-pulse bg-card"  />
            <div className="h-5 w-12 rounded animate-pulse bg-card"  />
          </div>
